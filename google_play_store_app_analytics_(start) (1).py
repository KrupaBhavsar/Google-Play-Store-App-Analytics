...
Original file is located at
    https://colab.research.google.com/drive/1J6htzjMxfw2rgKrA4ye-nrjpp2H7Y-q1
...
duplicate_rows=df_apps_clean[df_apps_clean.duplicated()]
...
fig=px.pie(values=ratings.values,labels=ratings.index)
fig.show()
